...
impl Staking for PolkadotStaking {
    ...
    async fn stake(&self, amount: u128, _validator: &str) -> StakingResult<Vec<u8>> { if amount < 10_000_000_000 { return Err(StakingError::MinimumStake(10_000_000_000)); } Ok(vec![0; 32]) }
