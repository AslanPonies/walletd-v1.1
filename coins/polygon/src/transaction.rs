...
impl PolygonTransaction {
    /// Create a simple POL transfer transaction
    pub fn transfer(to: &str, value: U256, chain_id: u64) -> Self {
        Self {
            from: None,
            to: to.to_string(),
            value,
            gas_limit: Some(21000), // Standard transfer gas
            gas_price: None,
    ...
    pub fn contract_call(to: &str, data: Vec<u8>, chain_id: u64) -> Self {
        Self {
            ...
            to: to.to_string(),
            value: U256::ZERO,
            gas_limit: Some(100000), // Higher limit for contracts
            gas_price: None,
            max_fee_per_gas: None,
            max_priority_fee_per_gas: None,
            nonce: None,
...
mod tests {
    ...
    fn test_transfer_transaction() {
        let tx = PolygonTransaction::transfer(
            ...
            U256::from(1_000_000_000_000_000_000u64), // 1 POL
            POLYGON_MAINNET,
        );
    ...
    fn test_contract_call_transaction() {
        ...
        let tx = PolygonTransaction::contract_call(
            "0x742d35Cc6634C0532925a3b844Bc9e7595f5fFb9",
            data.clone(),
            POLYGON_MAINNET,
        );
        assert_eq!(tx.value, U256::ZERO);
        assert_eq!(tx.gas_limit, Some(100000));
    ...
    #[test]
    fn test_is_eip1559() {
        let legacy_tx = PolygonTransaction::transfer(
            "0x742d35Cc6634C0532925a3b844Bc9e7595f5fFb9",
            U256::from(1000u64),
            POLYGON_MAINNET,
        )
        ...
        let eip1559_tx = PolygonTransaction::transfer(
            "0x742d35Cc6634C0532925a3b844Bc9e7595f5fFb9",
            U256::from(1000u64),
            POLYGON_MAINNET,
        )
