...
impl WalletDConfig {
    ...
    /// Save config to file
    /// 
    /// SECURITY FIX v1.1.0 (M-01): Config files are created with 0o600 permissions
    /// to prevent other users from reading sensitive configuration data.
